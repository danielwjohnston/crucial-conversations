# Review Queue - Material Processing Center

## 📁 Purpose

This folder is designed for dropping new or existing materials that need to be reviewed, analyzed, and incorporated into the Crucial Conversations training system.
...
- `.html` - Web pages or presentations
- `.md` - Markdown files
...
4. **Archive Storage** - Keep for reference
5. **Content Improvement** - Edit and enhance
